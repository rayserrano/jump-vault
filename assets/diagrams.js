...
(function () {
  ...
  var D = {
    ...
    "loop-bi": { t: "BI Surface", s: "the receipt, regenerable", b: "<p>When the consumer is satisfied, the agent drives the BI tool over MCP and materializes the conversation as a dashboard. Cheap to produce, disposable without ceremony, reprintable any time from the same definitions.</p><p>The surface survives. It just stops being the product.</p>" },
